                    ...
                    <div className="flex items-center justify-between h-20">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="flex items-center justify-center size-10 rounded-lg bg-primary/10 text-primary">
                                <span className="material-symbols-outlined text-3xl" aria-hidden="true">accessibility_new</span>
                            </div>
                        ...
                        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                            ...
                            <div className="flex flex-col gap-8 text-left max-w-2xl">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                                    ...
                                    >
                                        <span className="material-symbols-outlined mr-2 group-hover:animate-pulse" aria-hidden="true">record_voice_over</span>
                                        Get Started
                                    </Link>
                                </div>
                            </div>
                            ...
                            <div aria-hidden="true" className="relative flex justify-center items-center h-[400px] lg:h-[500px] w-full">
                                ...
                                <div className="absolute top-10 left-10 lg:left-20 bg-white dark:bg-surface-dark p-6 rounded-2xl shadow-2xl animate-float border border-gray-100 dark:border-gray-700">
                                    <span className="material-symbols-outlined text-6xl text-primary" aria-hidden="true">visibility</span>
                                </div>
                                {/* Icon 2: Hearing */}
                                <div className="absolute bottom-20 right-10 lg:right-20 bg-white dark:bg-surface-dark p-6 rounded-2xl shadow-2xl animate-float-delayed border border-gray-100 dark:border-gray-700">
                                    <span className="material-symbols-outlined text-6xl text-primary" aria-hidden="true">hearing</span>
                                </div>
                                {/* Icon 3: Speech */}
                                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-primary p-8 rounded-3xl shadow-2xl animate-pulse-slow z-10">
                                    <span className="material-symbols-outlined text-7xl text-white" aria-hidden="true">chat_bubble</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section aria-labelledby="features-heading" className="w-full py-20 bg-surface-light dark:bg-surface-dark border-y border-gray-100 dark:border-gray-800">
                    <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex flex-col gap-4 mb-16">
                            ...
                            <p className="text-lg text-text-muted dark:text-gray-500 max-w-3xl">Tools specifically engineered to make digital communication accessible, seamless, and human.</p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <div className="group flex flex-col p-8 rounded-xl bg-background-light dark:bg-background-dark border-2 border-transparent hover:border-primary/30 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                                ...
                                <p className="text-text-muted dark:text-gray-500 leading-relaxed">Type freely using high-contrast inputs, and our engine speaks for you in a natural tone.</p>
                            </div>

                            {/* Feature 2 */}
                            <div className="group flex flex-col p-8 rounded-xl bg-background-light dark:bg-background-dark border-2 border-transparent hover:border-primary/30 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                                <div className="size-14 rounded-full bg-primary/10 flex items-center justify-center text-primary mb-6 group-hover:bg-primary group-hover:text-white transition-colors">
                                    <span className="material-symbols-outlined text-3xl" aria-hidden="true">mic</span>
                                </div>
                                <h3 className="text-xl font-bold text-text-main dark:text-white mb-2">Voice-to-Text</h3>
                                <p className="text-text-muted dark:text-gray-500 leading-relaxed">Real-time captions for every conversation. Read what others are saying instantly.</p>
                            </div>

                            {/* Feature 3 */}
                            <div className="group flex flex-col p-8 rounded-xl bg-background-light dark:bg-background-dark border-2 border-transparent hover:border-primary/30 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                                <div className="size-14 rounded-full bg-primary/10 flex items-center justify-center text-primary mb-6 group-hover:bg-primary group-hover:text-white transition-colors">
                                    <span className="material-symbols-outlined text-3xl" aria-hidden="true">mood</span>
                                </div>
                                <h3 className="text-xl font-bold text-text-main dark:text-white mb-2">Mood Zone</h3>
                                <p className="text-text-muted dark:text-gray-500 leading-relaxed">Express complex feelings with high-contrast, scalable emotive visuals and patterns.</p>
                            </div>
                            ...
                            <div className="group flex flex-col p-8 rounded-xl bg-background-light dark:bg-background-dark border-2 border-transparent hover:border-primary/30 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                                ...
                                <p className="text-text-muted dark:text-gray-500 leading-relaxed">Private, encrypted conversations ensuring your data and specific needs remain yours.</p>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
                            <div className="max-w-2xl">
                                ...
                                <p className="text-lg text-text-muted dark:text-gray-500">Hear from the people who are redefining how they connect with the world.</p>
                            </div>
                        </div>
                        ...
                        <div aria-label="Testimonials Carousel" className="flex gap-6 overflow-x-auto snap-x snap-mandatory pb-8 no-scrollbar -mx-4 px-4 sm:mx-0 sm:px-0" role="region">
                            ...
                            <div className="snap-start shrink-0 w-[85vw] sm:w-[400px] flex flex-col p-8 rounded-xl bg-white dark:bg-surface-dark shadow-sm border border-gray-100 dark:border-gray-800">
                                <div className="flex items-center gap-4 mb-6">
                                    <div
                                        ...
                                        style={{ backgroundImage: "url('https://api.dicebear.com/7.x/initials/svg?seed=Alex')" }}
                                    ></div>
                                    <div>
                                ...
                                <div className="mt-auto pt-6 flex text-yellow-400">
                                    {[...Array(5)].map((_, i) => (
                                        <span key={i} className="material-symbols-outlined fill-current text-sm" aria-hidden="true">star</span>
                                    ))}
                                </div>
                            </div>
                            ...
                            <div className="snap-start shrink-0 w-[85vw] sm:w-[400px] flex flex-col p-8 rounded-xl bg-white dark:bg-surface-dark shadow-sm border border-gray-100 dark:border-gray-800">
                                <div className="flex items-center gap-4 mb-6">
                                    <div
                                        className="size-14 rounded-full bg-cover bg-center bg-no-repeat bg-gray-200"
                                        style={{ backgroundImage: "url('https://api.dicebear.com/7.x/initials/svg?seed=Jamie')" }}
                                    ></div>
                                    <div>
                            ...
                            <div className="snap-start shrink-0 w-[85vw] sm:w-[400px] flex flex-col p-8 rounded-xl bg-white dark:bg-surface-dark shadow-sm border border-gray-100 dark:border-gray-800">
                                <div className="flex items-center gap-4 mb-6">
                                    <div
                                        className="size-14 rounded-full bg-cover bg-center bg-no-repeat bg-gray-200"
                                        style={{ backgroundImage: "url('https://api.dicebear.com/7.x/initials/svg?seed=Taylor')" }}
                                    ></div>
                                    <div>
                            ...
                            <div className="snap-start shrink-0 w-[85vw] sm:w-[400px] flex flex-col p-8 rounded-xl bg-white dark:bg-surface-dark shadow-sm border border-gray-100 dark:border-gray-800">
                                <div className="flex items-center gap-4 mb-6">
                                    <div
                                        className="size-14 rounded-full bg-cover bg-center bg-no-repeat bg-gray-200"
                                        style={{ backgroundImage: "url('https://api.dicebear.com/7.x/initials/svg?seed=Sarah')" }}
                                    ></div>
                                    <div>
                ...
                <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
                        <div className="col-span-2 md:col-span-1">
                            <div className="flex items-center gap-2 mb-4">
                                <span className="material-symbols-outlined text-3xl text-primary" aria-hidden="true">accessibility_new</span>
                                <span className="text-xl font-bold text-text-main dark:text-white">De-Novo</span>
                            </div>
                            <p className="text-sm text-text-muted dark:text-gray-500 leading-relaxed">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                <li><a className="text-sm text-text-muted dark:text-gray-500 hover:text-primary transition-colors" href="#">Features</a></li>
                                <li><a className="text-sm text-text-muted dark:text-gray-500 hover:text-primary transition-colors" href="#">Safety</a></li>
                                <li><a className="text-sm text-text-muted dark:text-gray-500 hover:text-primary transition-colors" href="#">Download</a></li>
                            </ul>
                        </div>
                        <div>
                            <h4 className="font-bold text-text-main dark:text-white mb-4">Community</h4>
                            <ul className="space-y-3">
                                <li><a className="text-sm text-text-muted dark:text-gray-500 hover:text-primary transition-colors" href="#">Guidelines</a></li>
                                <li><a className="text-sm text-text-muted dark:text-gray-500 hover:text-primary transition-colors" href="#">Blog</a></li>
                                <li><a className="text-sm text-text-muted dark:text-gray-500 hover:text-primary transition-colors" href="#">Events</a></li>
                            </ul>
                        </div>
                        <div>
                            <h4 className="font-bold text-text-main dark:text-white mb-4">Support</h4>
                            <ul className="space-y-3">
                                <li><a className="text-sm text-text-muted dark:text-gray-500 hover:text-primary transition-colors" href="#">Help Center</a></li>
                                <li><a className="text-sm font-bold text-primary hover:underline" href="#">Accessibility Statement</a></li>
                                <li><a className="text-sm text-text-muted dark:text-gray-500 hover:text-primary transition-colors" href="#">Contact Us</a></li>
                            </ul>
                        </div>
                    </div>
                    <div className="border-t border-gray-200 dark:border-gray-800 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
                        ...
                        <div className="flex gap-6">
                            <a className="text-text-muted dark:text-gray-500 hover:text-primary transition-colors" href="#"><span className="sr-only">Twitter</span><span className="material-symbols-outlined text-xl" aria-hidden="true">share</span></a>
                            <a className="text-text-muted dark:text-gray-500 hover:text-primary transition-colors" href="#"><span className="sr-only">Instagram</span><span className="material-symbols-outlined text-xl" aria-hidden="true">photo_camera</span></a>
                            <a className="text-text-muted dark:text-gray-500 hover:text-primary transition-colors" href="#"><span className="sr-only">LinkedIn</span><span className="material-symbols-outlined text-xl" aria-hidden="true">work</span></a>
                        </div>
                    </div>
                </div>
            </footer>
